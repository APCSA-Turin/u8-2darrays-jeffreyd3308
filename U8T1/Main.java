public class Main {
    public static void main(String[] args) {
        String[][] nameList = {{"Abby", "Don", "George", "Kim"}, {"Brian", "Elenor", "Harry", "Lenny"}, {"Cathy", "Fred", "Jill", "Matt"}};
        ...
        String temp = nameList[0][0];
        nameList[0][0] = nameList[2][3];
        nameList[2][3] = temp;
        for (int i = 0; i < nameList.length; i++) {
            for (int j = 0; j < nameList[i].length; j++) {
                System.out.print(nameList[i][j] + " ");
